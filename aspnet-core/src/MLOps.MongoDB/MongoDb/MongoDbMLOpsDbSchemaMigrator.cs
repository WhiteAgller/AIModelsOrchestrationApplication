...
public class MongoDbMLOpsDbSchemaMigrator : IMLOpsDbSchemaMigrator, ITransientDependency
{
    private readonly IServiceProvider _serviceProvider;

    public MongoDbMLOpsDbSchemaMigrator(IServiceProvider serviceProvider)
    {
